...
public class OrderEntryPageSteps
{
    ...
    public void user_shold_select_delivery_date_from_popup()
    {
        ...
        {
            HelpersMethod.ClickBut(driver,HelpersMethod.FindByElement(driver,"xpath","//div[contains(@id,'dialog-title')]/following-sibling::div[contains(@class,'k-dialog-content')]/descendant::tr[2]"),10);
        }
    }
