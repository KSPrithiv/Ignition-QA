...
@CucumberOptions(features = {"src/test/resources/features/workqueue/assignmentlist/filteroption/WorkQueueFilterOptionScreen3.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class WorkQueueFilterOptionCucumberRunner3 extends AbstractTestNGCucumberTests {
