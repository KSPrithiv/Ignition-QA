...
@CucumberOptions(features = {"src/test/resources/features/outbound/loadplanning/OutboundLoadPlanning4.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundLoadPlanning4CucumberRunner extends AbstractTestNGCucumberTests {
