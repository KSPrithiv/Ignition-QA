...
@CucumberOptions(features = {"src/test/resources/features/outbound/outboundordersummary/filteroption/OutboundOrderSummaryFilterOption.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundOrderSummaryFilterOptionCucumberRunner extends AbstractTestNGCucumberTests {
