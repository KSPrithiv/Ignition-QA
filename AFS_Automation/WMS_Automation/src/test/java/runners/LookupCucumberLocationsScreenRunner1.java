...
@CucumberOptions(features = {"src/test/resources/features/lookup/lookuplocation/LookupLocationScreen1.feature"},
        glue = {"steps"},
        plugin = {"pretty",
        ...
        }, monochrome = true, tags = "@Lookup")

@Slf4j
public class LookupCucumberLocationsScreenRunner1 extends AbstractTestNGCucumberTests {
