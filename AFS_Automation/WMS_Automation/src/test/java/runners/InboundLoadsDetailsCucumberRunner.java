...
@CucumberOptions(features = {"src/test/resources/features/inbound/loads/loaddetails"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class InboundLoadsDetailsCucumberRunner extends AbstractTestNGCucumberTests {
