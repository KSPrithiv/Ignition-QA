...
@CucumberOptions(features = {"src/test/resources/features/inbound/inboundorders/details"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class InboundOrdersDetailsCucumberRunner extends AbstractTestNGCucumberTests {
