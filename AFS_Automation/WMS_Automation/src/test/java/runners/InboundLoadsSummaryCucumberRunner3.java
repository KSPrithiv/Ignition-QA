...
@CucumberOptions(features = {"src/test/resources/features/inbound/loads/loadsummary/InboundLoadSummaryScreen3.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class InboundLoadsSummaryCucumberRunner3 extends AbstractTestNGCucumberTests {
