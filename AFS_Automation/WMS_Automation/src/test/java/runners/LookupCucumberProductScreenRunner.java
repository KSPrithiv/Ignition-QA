...
@CucumberOptions(features = {"src/test/resources/features/lookup/lookupproduct/LookupProductScreen.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class LookupCucumberProductScreenRunner extends AbstractTestNGCucumberTests {
