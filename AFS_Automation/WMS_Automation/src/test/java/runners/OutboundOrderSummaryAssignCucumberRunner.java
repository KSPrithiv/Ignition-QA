...
@CucumberOptions(features = {"src/test/resources/features/outbound/outboundordersummary/assign/OutboundOrderSummaryAssign.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundOrderSummaryAssignCucumberRunner extends AbstractTestNGCucumberTests {
