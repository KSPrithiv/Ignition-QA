...
@CucumberOptions(features = {"src/test/resources/features/lookup/lookuplabels/LookupLabelsScreen.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class LookupCucumberLabelsScreenRunner extends AbstractTestNGCucumberTests {
