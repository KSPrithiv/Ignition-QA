...
@CucumberOptions(features = {"src/test/resources/features/workqueue/assignmentlist/filteroption/WorkQueueFilterOptionScreen1.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class WorkQueueFilterOptionCucumberRunner1 extends AbstractTestNGCucumberTests {
