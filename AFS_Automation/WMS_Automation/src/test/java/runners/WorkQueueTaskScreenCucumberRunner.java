...
@CucumberOptions(features = {"src/test/resources/features/workqueue/task/WorkQueueTaskScreen.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class WorkQueueTaskScreenCucumberRunner extends AbstractTestNGCucumberTests {
