...
@CucumberOptions(features = {"src/test/resources/features/outbound/processing/OutboundProcessing.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
public class OutboundProcessingRunner extends AbstractTestNGCucumberTests {
