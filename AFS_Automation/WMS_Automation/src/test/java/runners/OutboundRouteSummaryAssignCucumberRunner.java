...
@CucumberOptions(features = {"src/test/resources/features/outbound/outboundroutesummary/assign/OutboundRouteSummaryAssign.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundRouteSummaryAssignCucumberRunner extends AbstractTestNGCucumberTests {
