...
@CucumberOptions(features = {"src/test/resources/features/inbound/loads/loadsummary/InboundLoadSummaryScreen1.feature"},
        glue = {"steps"},
        plugin = {"pretty",
        ...
        }, monochrome = true, tags ="@1 or @21")
@Slf4j
public class InboundLoadsSummaryCucumberRunner1 extends AbstractTestNGCucumberTests {
