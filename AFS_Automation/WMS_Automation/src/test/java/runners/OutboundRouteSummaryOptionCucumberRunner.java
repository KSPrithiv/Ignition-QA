...
@CucumberOptions(features = {"src/test/resources/features/outbound/outboundroutesummary/routeoption/OutboundRouteSummaryOption.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundRouteSummaryOptionCucumberRunner extends AbstractTestNGCucumberTests {
