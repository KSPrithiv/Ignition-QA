...
@CucumberOptions(features = {"src/test/resources/features/workqueue/assignmentlist/filteroption/WorkQueueFilterOptionScreen4.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class WorkQueueFilterOptionCucumberRunner4 extends AbstractTestNGCucumberTests {
