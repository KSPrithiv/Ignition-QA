...
@CucumberOptions(features = {"src/test/resources/features/lookup/lookuplocation/LookupLocationScreen2.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class LookupCucumberLocationsScreenRunner2 extends AbstractTestNGCucumberTests {
