...
@CucumberOptions(features = {"src/test/resources/features/outbound/outboundordersummary/work/OutboundOrderSummaryWork.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class OutboundOrderSummaryWorkCucumberRunner extends AbstractTestNGCucumberTests {
