...
@CucumberOptions(features = {"src/test/resources/features/workqueue/assignmentlist/filteroption/WorkQueueFilterOptionScreen2.feature"},
        glue = {"steps"},
        plugin = {"pretty",
...
@Slf4j
public class WorkQueueFilterOptionCucumberRunner2 extends AbstractTestNGCucumberTests {
