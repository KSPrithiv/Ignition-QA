...
@NoArgsConstructor
@AllArgsConstructor
public class LookupSuppliers implements Serializable {
	...
	@JsonProperty("lookup supplier 7")
	private String lookupSupplier7;
	@JsonProperty("lookup supplier 8")
	private String lookupSupplier8;
}