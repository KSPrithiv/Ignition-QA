...
public class AllOrderPage
{
    ...
    public void CustomerIndexPopup() throws InterruptedException
    {
        ...
        String AccNo = TestBase.testEnvironment.get_Account();
            ...
            //Click on Check box
            HelpersMethod.WaitElementPresent(driver, "xpath", "//input[contains(@id,'CM_CUSTKEY')]", 80000);
            new WebDriverWait(driver, Duration.ofMillis(200000)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[contains(@id,'CM_CUSTKEY')]")));
    ...
    public void ClickOnShowQuotes()
    {
        ...
        try
        {
            ...
            new WebDriverWait(driver,Duration.ofMillis(10000)).until(ExpectedConditions.visibilityOf(ShowQuotes));
            new WebDriverWait(driver,Duration.ofMillis(10000)).until(ExpectedConditions.elementToBeClickable(ShowQuotes));
            status=HelpersMethod.returnDocumentStatus(driver);
            if(status.equals("loading"))
            {
                exists = HelpersMethod.waitTillLoadingPage(driver);
    ...
    public void SelectOrder() throws InterruptedException
    {
       ...
       WebElement WebEle;
        ...
        {
            new WebDriverWait(driver, Duration.ofMillis(20000)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(@class,'modal-sm modal-dialog')]")));
    ...
    public void NavigateToOrderSummaryPage()
    {
        ...
        try
        {
            ...
            if (HelpersMethod.waitTillTitleContains(driver, "Order Entry", 1000))
            {
                exists = true;
            }
    ...
    public void NotSubmitOptionFromDropDown()
    {
        ...
        try
        {
            ...
            HelpersMethod.ClickBut(driver,notSubmitOption,1000);
            exists=true;
            Assert.assertEquals(exists,true);
        }
        catch (Exception e) {}
    ...
    public void SelectNewOrderInPopUp() throws InterruptedException
    {
        try
        {
            ...
            if(HelpersMethod.IsExists("//h4[contains(text(),'Select order')]/ancestor::div[contains(@class,'modal-content')]",driver))
            {
                ...
                HelpersMethod.ActClick(driver, newOrderOption, 1000);
