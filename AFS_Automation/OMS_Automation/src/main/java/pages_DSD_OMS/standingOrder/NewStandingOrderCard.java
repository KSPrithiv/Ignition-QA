...
public class NewStandingOrderCard
{
    ...
    public void SelectEndDate(int i) throws InterruptedException
    {
        ...
        try {
            ...
            new WebDriverWait(driver, 800).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[contains(@class,'k-calendar-monthview')]")));
            Assert.assertEquals(exists, true);
        }
        catch (Exception e){}
    }
    ...
    public void DeleteStandingOrders() throws InterruptedException
    {
        ...
        Actions act1=new Actions(driver);
            ...
            for(WebElement SO:StandingOrders)
            {
                ...
                HelpersMethod.ClickBut(driver,SO,200);
                String status = HelpersMethod.returnDocumentStatus(driver);
                if (status.equals("loading"))
                {
                    HelpersMethod.waitTillLoadingPage(driver);
    ...
    public void copyStandingOrderDialogForEndDate(int dEnd) throws InterruptedException
    {
        ...
        //upon Visibility of End calender
    ...
    public void copySuccessPopup()
    {
       exists=false;
        ...
        HelpersMethod.WaitElementPresent(driver,"xpath","//div[contains(@class,'k-widget k-window k-dialog')]",200);
            HelpersMethod.waitTillElementLocatedDisplayed(driver,"xpath","//div[contains(@class,'k-widget k-window k-dialog')]",400);
            // to fetch the web element of the modal container
            ...
            //Click on Ok Button
            WebElement OkButton=copySuccessContainer.findElement(By.xpath(".//button"));
