...
public class CreditPage
{
    ...
    {
        HelpersMethod.ClickBut(driver,creditToCompanyDropDown,10000);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,creditToCustomerDropDown,10000);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,creditHoldCodeDropDown,10000);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,creditTermsDropDown,10000);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,creditServiceChargeDropDown,10000);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,creditRepDropDown,10000);
        selectDropDownValue();
    ...
    public void creditLimit()
    {
        ...
        HelpersMethod.EnterText(driver,creditLimit,10000,InputValue);
    ...
    public void memoLimit()
    {
        ...
        HelpersMethod.EnterText(driver,memoLimit,10000,InputValue);
