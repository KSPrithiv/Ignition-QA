...
public class OrderEntryPage
{
    ...
    public void deliveryContact()
    {
        ...
        HelpersMethod.EnterText(driver,deliveryContact,10,InputValue);
        scenario.log("DELIVERY CONTACT ENTERED IS "+HelpersMethod.JSGetValueEle(driver,deliveryContact,10));
    }
    public void firstName()
    {
        InputValue=EnterText(firstName,10);
        HelpersMethod.EnterText(driver,firstName,10,InputValue);
        scenario.log("FIRST NAME ENTERED IS "+HelpersMethod.JSGetValueEle(driver,firstName,10));
    }
    public void telePhone()
    {
        InputValue=EnterNumber(telePhone,10);
        HelpersMethod.EnterText(driver,telePhone,10,InputValue);
        scenario.log("TELEPHONE NUMBER ENTERED IS "+HelpersMethod.JSGetValueEle(driver,telePhone,10));
    }
    public void emailAddress()
    {
        HelpersMethod.EnterText(driver,emailAddress,10,RandomValues.generateEmail(10));
        scenario.log("EMAIL ADDRESS ENTERED IS "+HelpersMethod.JSGetValueEle(driver,emailAddress,10));
    }

    public void defaultOrderTypeDropDown()
    {
        HelpersMethod.ClickBut(driver,defaultOrderTypeDropDown,40);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,intialProductsDropDown,40);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,standingOrderCodeDropDown,40);
        selectDropDownValue();
    ...
    {
        HelpersMethod.ClickBut(driver,authorizedProductsDropDown,40);
        selectDropDownValue();
    ...
    public void allocationRank()
    {
        ...
        HelpersMethod.EnterText(driver,allocationRank,10,InputValue);
        scenario.log("ALLOCATION RANK ENTERED IS "+HelpersMethod.JSGetValueEle(driver,firstName,10));
    }
    public void allocationFactor()
    {
        InputValue=EnterText(allocationFactor,10);
        HelpersMethod.EnterText(driver,allocationFactor,10,InputValue);
        scenario.log("FIRST NAME ENTERED IS "+HelpersMethod.JSGetValueEle(driver,allocationFactor,10));
    }

    public void backOrderDropDown()
    {
        HelpersMethod.ClickBut(driver,backOrderDropDown,40);
        selectDropDownValue();
