...
public class NewOrderEntryPage
{
    ...
    public void EnterProdNo_InSearchBarAutoSearch(String Product)
    {
        exists=false;
    ...
    public void EnterForignLanguage_InSearchBar(String Product)
    {
        ...
        try
        {
            ...
            {
                //HelpersMethod.ActSendKey(driver,SearchProd,10000,Product);
                SearchProd.click();
                ...
                if(HelpersMethod.IsExists("//div[@id='react-autowhatever-search-option-selection']",driver))
                {
                    List<WebElement> suggests=HelpersMethod.FindByElements(driver,"xpath","//ul[contains(@class,'autosuggest')]/li/descendant::span[@class='product-name']");
                    for(WebElement suggest:suggests)
                    {
                        act.moveToElement(suggest).build().perform();
                        suggText=suggest.getText();
    ...
    public void EnterQtyForDescSearch(String unit, String cas) throws InterruptedException
    {
        Thread.sleep(4000);
        exists = false;
        WebElement WebEle;
        ...
        try
        {
            ...
            if (HelpersMethod.IsExists("//span[text()='Catalog']/ancestor::div[contains(@class,'k-window k-dialog')]", driver))
            {
                ...
                {
                    //Enter Unit value in input box of catalog
                    if (HelpersMethod.IsExists("//div[contains(@class,'k-window k-dialog')]/descendant::div[contains(@id,'gridItemBox')]["+counter+"]/descendant::div[contains(text(),'Unit')]/descendant::input", driver))
                    {
                        WebEle = HelpersMethod.FindByElement(driver, "xpath", "//div[contains(@class,'k-window k-dialog')]/descendant::div[contains(@id,'gridItemBox')]["+counter+"]/descendant::div[contains(text(),'Unit')]/descendant::input");
                        HelpersMethod.ScrollElement(driver, WebEle);
                        act1.moveToElement(WebEle).click().build().perform();
                        act1.sendKeys(Keys.CONTROL + "a");
                        act1.sendKeys(Keys.DELETE);
                    ...
                    //Enter Case value in input box of catalog
                    if (HelpersMethod.IsExists("//div[contains(@class,'k-window k-dialog')]/descendant::div[contains(@id,'gridItemBox')]["+counter+"]/descendant::div[contains(text(),'Case')]/descendant::input", driver))
                    {
                        WebEle = HelpersMethod.FindByElement(driver, "xpath", "//div[contains(@class,'k-window k-dialog')]/descendant::div[contains(@id,'gridItemBox')]["+counter+"]/descendant::div[contains(text(),'Case')]/descendant::input");
                        HelpersMethod.ScrollElement(driver, WebEle);
                        act1.moveToElement(WebEle).click().build().perform();
                        act1.sendKeys(Keys.CONTROL + "a");
                        act1.sendKeys(Keys.DELETE);
                ...
                else if (HelpersMethod.IsExists("//div[contains(@class,'grid-view')]/ancestor::div[contains(@class,'k-window k-dialog')]", driver))
                {
                    ...
                    for (WebElement tableHead : tableHeads)
                    {
                        ...
                        if (THead_Text.equals("Units"))
                        {
                            if(HelpersMethod.IsExists("//div[@class='i-grid']/descendant::tr[contains(@class,'k-master-row')]["+counter+"]/descendant::td[" + b + "]/descendant::input",driver))
                            {
                                UnitCase = HelpersMethod.FindByElement(driver, "xpath", "//div[@class='i-grid']/descendant::tr[contains(@class,'k-master-row')]["+counter+"]/descendant::td[" + b + "]/descendant::input");
                                HelpersMethod.ScrollElement(driver, UnitCase);
                                if (UnitCase.isDisplayed() && UnitCase.isEnabled())
                                {
                                    HelpersMethod.ActSendKey(driver, UnitCase, 10000, unit);
            ...
            if(HelpersMethod.IsExists("//span[text()='Catalog']/ancestor::div[contains(@class,'k-window k-dialog')]",driver))
            {
                ...
                else  if(HelpersMethod.IsExists("//div[@class='i-grid']",driver))
                {
                        ...
                        for (WebElement tableHead : tableHeads)
                        {
                            ...
                            WebElement UnitCase;
                            String THead_Text = tableHead.getText();
                            if (THead_Text.equals("Units")||THead_Text.equals("Cases"))
                            {
                                if(HelpersMethod.IsExists("//div[contains(@class,'k-window k-dialog')]/descendant::tr[contains(@class,'k-master-row')][1]/descendant::td[" + (b+1) + "]/descendant::input",driver))
                                {
                                    UnitCase = HelpersMethod.FindByElement(driver, "xpath", "//div[contains(@class,'k-window k-dialog')]/descendant::tr[contains(@class,'k-master-row')][1]/descendant::td[" + (b+1) + "]/descendant::input");
                                    HelpersMethod.ScrollElement(driver, UnitCase);
                                    if (UnitCase.isDisplayed())
                                    {
                                ...
                                {
                                    scenario.log("column value is"+b);
                                    if (HelpersMethod.IsExists("//div[contains(@class,'k-window k-dialog')]/descendant::tr[contains(@class,'k-master-row')][1]/descendant::td[" + (b +1)+ "]/descendant::input", driver))
                                    {
                                        //Find whether Cases input box is displayed
                                        UnitCase = HelpersMethod.FindByElement(driver, "xpath", "//div[contains(@class,'k-window k-dialog')]/descendant::tr[contains(@class,'k-master-row')][1]/descendant::td[" + (b+1) + "]/descendant::input");
...
//                HelpersMethod.ActClick(driver, WebEle, 10000);
    ...
    public void Add_Product_From_Catalog()
    {
        ...
        try
        {
            ...
            new WebDriverWait(driver,Duration.ofMillis(10000)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ul[@id='addButton-accessibility-id']/li/descendant::span[@class='k-menu-link-text']")));

            List<WebElement> menuContainers = HelpersMethod.FindByElements(driver,"xpath","//ul[@id='addButton-accessibility-id']/li/descendant::span[@class='k-menu-link-text']");
            for(WebElement menuContainer:menuContainers)
            {
                act.moveToElement(menuContainer).build().perform();
                addListText= menuContainer.getText();
                if(addListText.equalsIgnoreCase("From Catalog"))
                {
                    act.moveToElement(menuContainer).build().perform();
                    act.click(menuContainer).build().perform();
    ...
    public void Validate_Catalog()
    {
        ...
        try
        {
            new WebDriverWait(driver,Duration.ofMillis(20000)).until(ExpectedConditions.refreshed(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(@class,'product-catalog-container')]/ancestor::div[contains(@class,'k-window k-dialog')]"))));
            new WebDriverWait(driver,Duration.ofMillis(20000)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'product-catalog-container')]/ancestor::div[contains(@class,'k-window k-dialog')]")));
    ...
    public void Search_Prod_in_Catalog(String Prods) throws InterruptedException
    {
        ...
        try
        {
            ...
            {
                //Click on 'Add filter'
                WebEle = catalogPopup.findElement(By.xpath("//div[contains(@class,'k-window k-dialog')]/descendant::button[contains(@class,'i-filter-tag__main')]/descendant::span[text()='Add filter']"));
                HelpersMethod.ActClick(driver, WebEle, 10000);
            ...
            else
            {
                ...
                if(HelpersMethod.IsExists("//div[@class='product-catalog-container']/ancestor::div[contains(@class,'k-window k-dialog')]",driver))
                {
                    ...
                    {
                        WebEle = catalogPopup.findElement(By.xpath("//div[contains(@class,'k-window k-dialog')]/descendant::span[contains(@class,'right-button')]"));
                        HelpersMethod.ScrollElement(driver, WebEle);
    ...
    public void Catalog_OK()
    {
        ...
        try
        {
            if(HelpersMethod.IsExists("//span[text()='Catalog']/ancestor::div[contains(@class,'k-window k-dialog')]/descendant::button/span[text()='Ok']",driver))
            {
...
//            scenario.log("ORDER IMPORTED IS "+Ord_no);
    ...
    public void EnterUnusualUnitQtyProductLine(String Unit)
    {
        ...
        try
        {
            WebEle=HelpersMethod.FindByElement(driver,"id","orderEntryGridContainer");
            HelpersMethod.ScrollElement(driver,WebEle);
            if (HelpersMethod.IsExists("//tr[contains(@class,'k-master-row')][1]/descendant::input[contains(@id,'TotalUnits')]", driver))
            {
                List<WebElement> unitInputs = HelpersMethod.FindByElements(driver, "xpath", "//tr[contains(@class,'k-master-row')][1]/descendant::input[contains(@id,'TotalUnits')]");
                for (WebElement unitInput : unitInputs)
                {
                    if (unitInput.isDisplayed())
                    {
                        HelpersMethod.ScrollElement(driver, unitInput);
                        HelpersMethod.EnterText(driver,unitInput,10000,"");
                        HelpersMethod.ActSendKey(driver, unitInput, 10000, Unit);
    ...
    public void EnterUnusualCaseQtyProductLine(String Case)
    {
        ...
        try
        {
            WebEle = HelpersMethod.FindByElement(driver, "id", "orderEntryGridContainer");
            HelpersMethod.ScrollElement(driver, WebEle);
            if (HelpersMethod.IsExists("//tr[contains(@class,'k-master-row')][1]/descendant::input[contains(@id,'TotalCases')]", driver))
            {
                List<WebElement> caseInputs = HelpersMethod.FindByElements(driver, "xpath", "//tr[contains(@class,'k-master-row')][1]/descendant::input[contains(@id,'TotalCases')]");
                for (WebElement caseInput:caseInputs)
                {
                    if(caseInput.isDisplayed())
                    {
                        HelpersMethod.ScrollElement(driver,caseInput);
                        HelpersMethod.EnterText(driver,caseInput,10000,"");
                        HelpersMethod.ActSendKey(driver,caseInput,10000,Case);
    ...
    public void readProducts()
    {
        ...
        try
        {
            ...
            {
                scenario.log("<span style='color:red'>PRODUCTS FOUND ARE:::::</span>");
    ...
    public void selectOGDropDown()
    {
            ...
            try
            {
                List<WebElement> allProds=HelpersMethod.FindByElements(driver,"xpath", "//ul[@id='CPorderGuies-listbox-id']/li/span");
                ...
                Thread.sleep(1000);
                WebElement dropDown1=HelpersMethod.FindByElement(driver,"xpath","//span[@id='CPorderGuies-accessibility-id']/span[@class='k-input-value-text']");
                String selectValue=dropDown1.getText();
    ...
    public void selectBrandDropDown()
    {
        ...
        try
        {
            ...
            for(WebElement prod:allProds)
            {
                act.moveToElement(prod).build().perform();
                prods=prod.getText();
                if(prods.equalsIgnoreCase(brand))
                {
                    act.moveToElement(prod).build().perform();
                    act.click(prod).build().perform();
                    break;
    ...
    public void clickOnGridTypeDropdown()
    {
        ...
        try
        {
            ...
            if(HelpersMethod.IsExists("//button[@data-test-id='grid-selection']/span",driver))
            {
                ...
                HelpersMethod.ClickBut(driver,gridType,10000);
                exists=true;
            }
            Assert.assertEquals(exists,true);
        }
        ...
        try
        {
            ...
            if(HelpersMethod.IsExists("//button[@class='i-grid__filter-button']",driver))
            {
               ...
               //Find all the headers of catalog dialog box, when displayed in list view
                List<WebElement> headers = HelpersMethod.FindByElements(driver, "xpath", "//div[@class='k-window k-dialog']/descendant::span[contains(@class,'k-column-title')]");
                ...
                WebElement catalogFilter=HelpersMethod.FindByElement(driver,"xpath","//div[@class='k-window k-dialog']/descendant::tr[contains(@class,'k-filter-row')]/th["+i+"]/descendant::input");

                WebElement filterInput= driver.findElement(By.xpath("//div[@class='k-window k-dialog']/descendant::tr[contains(@class,'k-filter-row')]/th["+i+"]/descendant::input"));
                act1.moveToElement(filterInput).click().build().perform();
//                HelpersMethod.JSSetValueEle(driver,filterInput,10000,"");
//                filterInput.sendKeys(Keys.BACK_SPACE);
//                HelpersMethod.JSSetValueEle(driver,filterInput,10000,searchValue);
                HelpersMethod.EnterText(driver,filterInput,10000,searchValue);

                //Click on filter icon
                WebElement filterIcon=HelpersMethod.FindByElement(driver,"xpath","//div[@class='k-window k-dialog']/descendant::tr[contains(@class,'k-filter-row')]/th["+i+"]/descendant::span[contains(@class,'k-dropdownlist')]/button[contains(@class,'input')]");
                HelpersMethod.JScriptClick(driver,filterIcon,10000);
                List<WebElement> Lists=HelpersMethod.FindByElements(driver,"xpath","//div[contains(@class,'k-list-container')]/descendant::ul[@class='k-list-ul']/li/span");
    ...
    public void cardCatelog()
    {
      exists=false;
      String catText;
      String catSelect=TestBase.testEnvironment.get_Brand();
      Actions act1=new Actions(driver);
      try
      {
          //Click on Category drop down
          WebElement catalogDropdown=HelpersMethod.FindByElement(driver,"xpath","//span[@id='CPsizes-accessibility-id']");
          HelpersMethod.ActClick(driver,catalogDropdown,10000);
          //create list of elements in dropdown
          List<WebElement> categoryLists=HelpersMethod.FindByElements(driver,"xpath","//ul[@id='CPsizes-listbox-id']/li/span");
          ...
          String catelogText=HelpersMethod.FindByElement(driver,"xpath","//span[@id='CPsizes-accessibility-id']/span[@class='k-input-value-text']").getText();
        ...
        try
        {
            ...
            for(int i=0;i<=1;i++)
           {
               ...
               if (HelpersMethod.IsExists("//div[@class='toast-message' and contains(text(),'This product is currently low on inventory.')]", driver))
               {
                   ...
                   HelpersMethod.ActClick(driver, toastCurrentlyUnavailable, 20000);
                   scenario.log("TOAST MESSAGE FOR: CURRENTLY LOW ON INVENTORY HAS BEEN HANDLED");
    ...
    public void validateDisplayCatalogProducts()
    {
        exists=false;
        try
        {
            ...
            {
                scenario.log("CATALOG HAS BEEN FOUND");
                exists=true;
            }
            Assert.assertEquals(exists,true);
        }
    ...
    public void validateCatalogProducts()
    {
        ...
        String prodDesText;
        Actions act=new Actions(driver);
        String prodDescription= TestBase.testEnvironment.getProdDesc();
        try
        {
            Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
                    .withTimeout(Duration.ofSeconds(600))
            ...
            else
            {
                ...
                if(HelpersMethod.IsExists("//div[@class='k-window k-dialog']/descendant::div[@class='i-grid']",driver))
                {
                    ...
                    WebElement inputBox=HelpersMethod.FindByElement(driver,"xpath","//div[@class='k-window k-dialog']/descendant::tr[contains(@class,'k-filter-row')]/th["+i+"]/descendant::input");
                    HelpersMethod.EnterText(driver,inputBox,10000,prodDescription);
                    exists=true;
                    wait = new FluentWait<WebDriver>(driver)
                            .withTimeout(Duration.ofSeconds(600))
                            .pollingEvery(Duration.ofSeconds(2))
                ...
                {
                    WebElement searchBox=HelpersMethod.FindByElement(driver,"xpath","//div[@class='k-window k-dialog']/descendant::input[contains(@class,'autosuggest')]");
                    HelpersMethod.EnterText(driver,searchBox,10000,prodDescription);
                    new WebDriverWait(driver,Duration.ofMillis(10000)).until(ExpectedConditions.refreshed(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='k-window k-dialog']/descendant::ul[contains(@class,'autosuggest')]/descendant::span[@class='product-number']/following-sibling::span[1]"))));
                    new WebDriverWait(driver,Duration.ofMillis(10000)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='k-window k-dialog']/descendant::ul[contains(@class,'autosuggest')]/descendant::span[@class='product-number']/following-sibling::span[1]")));

                    List<WebElement> prodDescriptions = HelpersMethod.FindByElements(driver, "xpath", "//div[@class='k-window k-dialog']/descendant::ul[contains(@class,'autosuggest')]/descendant::span[@class='product-number']/following-sibling::span[1]");
                    for (WebElement prodDes : prodDescriptions)
                    {
                        ...
                        {
                            act.moveToElement(prodDes).build().perform();
                            act.click(prodDes).build().perform();
                            exists = true;
                            break;
                        }
                    }
    ...
    public void validateCatalogProdDescription()
    {
        exists=false;
        String prodDesText;
        Actions act=new Actions(driver);
    ...
    public void verifyPriceColumn()
    {
        ...
        try
        {
            if(HelpersMethod.IsExists("//div[@class='card-view']",driver))
            {
                ...
                WebElement prodDes = HelpersMethod.FindByElement(driver, "xpath", "//div[@class='product-number']");
                HelpersMethod.ScrollElement(driver, prodDes);
            }
            //Code to verify existence of price value in grid or card layout catalog
            if(HelpersMethod.IsExists("//span[contains(@class,'item-name') and contains(text(),'Price')]|//div[contains(@class,'k-window k-dialog')]/descendant::span[@class='k-column-title' and contains(text(),'Price')]|//span[contains(@class,'item-name') and contains(text(),'price')]|//div[contains(@class,'k-window k-dialog')]/descendant::span[@class='k-column-title' and contains(text(),'price')]",driver))
            {
    ...
    public void validateGridSelected(String selectGrid)
    {
        exists=false;
        try
        {
            String gridName=HelpersMethod.FindByElement(driver,"xpath","//button[@data-test-id='grid-selection']/span").getText();
            scenario.log("GRID NAME FOUND IN NEW OE IS "+gridName);
            if(gridName.contains(selectGrid))
            {
                exists=true;
            }
            Assert.assertEquals(exists,true);
    ...
    public void selectMainGrid()
    {
        Actions act=new Actions(driver);
        String dropText;
        try
        {
            if(!HelpersMethod.IsExists("//button[@data-test-id='grid-selection']/span[text()='Main grid']",driver))
            {
                WebElement gridDrop=HelpersMethod.FindByElement(driver,"xpath","//button[@data-test-id='grid-selection']");
                HelpersMethod.ClickBut(driver,gridDrop,10000);
                List<WebElement> dropValues=HelpersMethod.FindByElements(driver,"xpath","//ul[@id='grid-selection-accessibility-id']/descendant::span[@class='k-menu-link-text']");
                for(WebElement dropValue:dropValues)
                {
                   act.moveToElement(dropValue).build().perform();
                   dropText=dropValue.getText();
                   if(dropText.contains("Main"))
                   {
                       act.moveToElement(dropValue).build().perform();
    ...
    public void selectAllProductsCatalogDialogbox()
    {
            Actions act=new Actions(driver);
            String dropText;
            try
    ...
    {
        Actions act=new Actions(driver);
        String showAllProdText;
        try
        {
            if(!HelpersMethod.IsExists("//span[@id='filterByQuantities-accessibility-id']/span[text()='Show all products']",driver))
            {
                WebElement showAllProduct=HelpersMethod.FindByElement(driver,"id","filterByQuantities-accessibility-id");
                HelpersMethod.ActClick(driver,showAllProduct,10000);
                //select show all product from drop down
                List<WebElement> showAllProds=HelpersMethod.FindByElements(driver,"xpath","//ul[@id='filterByQuantities-listbox-id']/descendant::span");
                for(WebElement showAllProd:showAllProds)
                {
                    act.moveToElement(showAllProd).build().perform();
                    showAllProdText=showAllProd.getText();
                    if(showAllProdText.equalsIgnoreCase("Show all products"))
                    {
                        act.click(showAllProd).build().perform();
                        break;
                    }
                }
            }
    ...
    public void setToDefaultValue()
    {
        ...
        try
        {
            ...
            if(HelpersMethod.IsExists("//div[@class='selectPriceOverride']/ancestor::div[contains(@class,'k-window k-dialog')]",driver))
            {
                ...
                scenario.log("PRICE OVERIDE SET TO DEFAULT");
                exists=true;
            }
            Assert.assertEquals(exists,true);
        }
    ...
    public void findDuplicateProducts()
    {
        exists=false;
        Actions act=new Actions(driver);
        String prodText;
    ...
    public void readGridHeaderNames(List<String> columnNames)
    {
        exists=false;
        Actions act=new Actions(driver);
        String headText;
        try
        {
            List<WebElement> headers=HelpersMethod.FindByElements(driver,"xpath","//span[@class='k-column-title'][not(text()=' ')]");
    ...
    public void searchForForeignLanguageProductInProductGrid()
    {
        Actions act=new Actions(driver);
        String prodTex;
        ...
        try
        {
            List<WebElement> prods=HelpersMethod.FindByElements(driver,"xpath","//tr[contains(@class,'k-master-row')]/descendant::span[contains(@class,'CPKendoDataGrid-Label')]");
            for(WebElement prod:prods)
            {
                qtyIndex++;
                act.moveToElement(prod).build().perform();
                prodTex=prod.getText();
                if(prodTex.contains(TestBase.testEnvironment.getForeignLangDesc()))
                {
                    break;
                }
            }
    ...
    public void EnterQtyForeignLang_ProductGrid(WebDriver driver, List<List<String>> qty)
    {
        try
        {
            WebElement WebEle;
            ...
            if (HelpersMethod.IsExists("//table[contains(@class,'k-grid-table')]",driver))
            {
                ...
                {
                    //Check Whether Cases is enabled or not
                    if (HelpersMethod.IsExists("//tr["+qtyIndex+"]/descendant::input[contains(@id,'TotalCasesCol')]", driver))
                    {
                        WebEle = driver.findElement(By.xpath("//tr["+qtyIndex+"]/descendant::input[contains(@id,'TotalCasesCol')]"));
                        HelpersMethod.EnterText(driver, WebEle, 10000, qty.get(i).get(0));
                        WebEle.sendKeys(Keys.TAB);
                        scenario.log("QTY ENTERED IN CASES INPUTBOX "+qty.get(i).get(0));
                        Thread.sleep(500);
                        for (int j = 0; j <= 3; j++)
                        {
                            //Check for 'Qty exceeds maximum of' Popup
                    ...
                    //Check Whether Units is enabled or not
                    if (HelpersMethod.IsExists("//tr["+qtyIndex+"]/descendant::input[contains(@id,'TotalUnitsCol')]", driver))
                    {
                        WebEle = driver.findElement(By.xpath("//tr["+qtyIndex+"]/descendant::input[contains(@id,'TotalUnitsCol')]"));
                        HelpersMethod.EnterText(driver, WebEle, 10000,qty.get(i).get(1));
                        WebEle.sendKeys(Keys.TAB);
                        scenario.log("QTY ENTERED IN UNIT INPUTBOX "+qty.get(i).get(1));
                        Thread.sleep(500);
                        for (int j = 0; j <= 3; j++)
                        {
                            //Check for 'Qty exceeds maximum of' Popup
