 ...
 */
@CucumberOptions
        (features = "src/test/resources/features_DSD_OMS/StandingOrderFeature",
                ...
                monochrome = true,tags = "@GenerateStandingOrder")

public class TestRunnerStandingOrder extends AbstractTestNGCucumberTests
{
