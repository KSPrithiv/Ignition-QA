 ...
 */
@CucumberOptions
        (features = "src/test/resources/features_DSD_OMS/QuoteFeature",
                ...
                monochrome = true,tags="@ConvertQuoteToOrder")

public class TestRunnerQuote  extends AbstractTestNGCucumberTests
{
