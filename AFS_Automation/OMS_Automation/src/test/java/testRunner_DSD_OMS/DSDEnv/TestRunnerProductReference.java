 ...
 */
@CucumberOptions(features = "src/test/resources/features_DSD_OMS/ProductReferenceFeature",
...
public class TestRunnerProductReference extends AbstractTestNGCucumberTests
{
