package stepDefination_DSD_OMS.StatementsPageSteps;
...
public class StatementsPageSteps
{
    ...
    public void userMovesMouseControlToCustomerAccountAndClicksOnSortArrow()
    {
        statementsPage=new StatementsPage(driver,scenario);
        statementsPage.readAllCustomerAccount();
        statementsPage.moveToCustomerAccountNoColumn();
        statementsPage.readAllCustomerAccountAfterSorting();
        statementsPage.validatingSorting();
    }

    @And("User moves mouse control to customer name and clicks on sort arrow")
    public void userMovesMouseControlToCustomerNameAndClicksOnSortArrow()
    {
        statementsPage=new StatementsPage(driver,scenario);
        statementsPage.readAllCustomerName();
